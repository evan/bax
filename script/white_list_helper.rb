...
WhiteListHelper.tags       = %w(strong em b i p code pre sub sup cite br span ul ol li abbr acronym a img)
WhiteListHelper.attributes = %w(href src alt cite datetime title)
WhiteListHelper.protocols  = %w(ftp http https feed)
